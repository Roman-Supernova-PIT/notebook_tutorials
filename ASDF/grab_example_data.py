####
# This is copied from the data download code in
#
# https://github.com/spacetelescope/roman-data-workshop/blob/main/data/download.py
#
# to facilitate running the ASDF example notebook
...
STPSF_DATA = Path('.')/'stpsf-data-LATEST.tar.gz'
...
if __name__ == "__main__":
        download_data()
        shutil.unpack_archive(STPSF_DATA, Path('.'))
